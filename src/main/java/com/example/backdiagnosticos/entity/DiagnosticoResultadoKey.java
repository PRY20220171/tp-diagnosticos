...
@AllArgsConstructor
@PrimaryKeyClass
@JsonIdentityInfo(generator = ObjectIdGenerators.IntSequenceGenerator.class, property = "@id", scope = DiagnosticoResultadoKey.class)
public class DiagnosticoResultadoKey implements Serializable {
