...
public class DiagnosticoXPrueba  implements Serializable {
    ...
    @ApiModelProperty(value="Llave compuesta que vincula tratamiento y resultado", dataType="DiagnosticoXPruebaKey", position=0)
    @PrimaryKey
    private DiagnosticoPruebaKey diagnosticoPruebaKey;
/*
    @ManyToOne
